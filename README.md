...
* [cpp14-project-template](https://github.com/arnavb/cpp14-project-template) - A C++14 template with CI, tests, code coverage, doxygen and static analysis integration. [```[CC0-1.0]```][CC0-1.0]
